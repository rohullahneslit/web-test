...
const Listings = () => {
  return (
    <div className="w-full lg:flex-row flex-col rounded-[10px 10px 150px 10px] h-[600px]  bg-[#E8EFFF]  flex justify-between items-center">
      <div className="lg:w-1/2 w-full pl-4 lg:pl-0 tracking-tight	flex-col flex justify-center items-center bg-[] h-fit p-[20px]">
        <div className="w-[80%] h-fit">
          ...
          <div className="flex lg:justify-start justify-center items-center">
            <Button className="bg-primary font-semibold w-56">
      ...
      <div className="lg:w-[40%]  w-[100%] bg-slate-50 h-[100%] relative">
        <div className=" absolute bottom-0  right-0	 w-full bg-[#fff] h-fit">
          <img
